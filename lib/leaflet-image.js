...
// leaflet-image
module.exports = function leafletImage(map, dimensions, layers, callback) {

    var layerQueue = new queue(1);
    
    dimensions = dimensions ? dimensions : map.getSize();
    ...
    function handleTileLayer(layer, callback) {
        ...
        function loadTile(url, tilePos, tileSize, callback) {
            ...
            im.src = url.replace( /.*cache\/png\//g, tileserver );
        }
